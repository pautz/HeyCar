...
if (isset($_SESSION["loggedin_odonto2"]) && $_SESSION["loggedin_odonto2"] === true) {
    header("Location: https://carlitoslocacoes.com/HeyCar/caronas2/nossasmaquinas/voos.php"); // página protegida
    exit;
}
                ...
                if (mysqli_stmt_num_rows($stmt) == 1) {
                    ...
                    if (mysqli_stmt_fetch($stmt)) {
                        if (password_verify($password, $hashed_password)) {
                            ...
                            header("Location: https://carlitoslocacoes.com/HeyCar/caronas2/nossasmaquinas/voos.php");
                            exit;
                        } else {
